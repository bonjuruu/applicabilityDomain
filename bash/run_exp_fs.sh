...
# Example:
# python ./experiments/pipeline_fs.py -d Ames --clf svm --clfArg "{\"C\": 10}"
# python ./experiments/pipeline_fs.py -d Ames --clf nn --clfArg "{\"batch_size\": 128, \"hidden_dim\": 512}"

for DATA in ${DATALIST[@]}; do
    for ((I=0; I<${#CLASSIFIERS[@]}; I++)); do
        python ./experiments/pipeline_fs.py -d $DATA --clf ${CLASSIFIERS[I]} --clfArg "${CLF_ARGS[I]}"
    done
done 
