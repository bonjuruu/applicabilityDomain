...
from .distance import (DISTANCE_METRICS, DAIndexDelta, DAIndexGamma,
                       DAIndexKappa)
from .evaluate import (cumulative_accuracy, permutation_auc,
...
__all__ = [
    ...
    'cumulative_accuracy', 'permutation_auc', 'predictiveness_curves',
    'roc_ad', 'save_roc', 'sensitivity_specificity',
